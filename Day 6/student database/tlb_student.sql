...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2021 at 12:18 PM
...
(3, 'Nidhi makwana', 'bansaridodiya18@gmail.com', 9574777002, 'Bhavnagar', 342816, 'Female', '1998-02-01', 'O+', '09876');
...
--
ALTER TABLE `tlb_student`
  MODIFY `stud_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
